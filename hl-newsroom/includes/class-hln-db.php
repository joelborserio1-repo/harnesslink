 ...
 *
 * Four tables, all introduced in Phase 2:
 *   hln_intake_log        – every raw item from any intake channel (email
 *                            in Phase 2; RSS + X added in Phase 3), with its
 *                            processed/unclassified/quarantined status.
 *                            Phase 3's closing note confirms RSS and X feed
 *                            into this same table rather than one of their own.
 ...
 *                            calendar entry.
 *   hln_monitored_state   – last-seen content hash per monitored-page
 *                            source, so the fetch+diff job only surfaces
