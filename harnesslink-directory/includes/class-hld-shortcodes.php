...
class HLD_Shortcodes {
     ...
     * [harnesslink_advertise scheduler="https://cal.diy/team/intro"]  → booking calendar URL
     * [harnesslink_advertise scheduler_type="cal"]  → force the embed (auto|calendly|cal)
    ...
    public static function advertise( $atts ) {
        ...
        $hld_scheduler_type = $a['scheduler_type'] ?: get_option( 'hld_scheduler_type', 'auto' );
        ...
        $hld_scheduler_type = in_array( $hld_scheduler_type, array( 'auto', 'calendly', 'cal' ), true ) ? $hld_scheduler_type : 'auto';
