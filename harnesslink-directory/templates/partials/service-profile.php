...
/**
 * Generic ("service") listing profile body — trainers, drivers, vets, etc.
 * Unchanged from the pre-redesign template. Expects the same variables as
 * templates/stallion-profile.php (it is included directly from there).
 */
?>
